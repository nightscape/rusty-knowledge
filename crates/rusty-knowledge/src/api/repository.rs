...
use crate::api::streaming::ChangeNotifications;

use super::types::{ApiError, Block, NewBlock, Traversal};
...
pub trait CoreOperations: Send + Sync {
    ...
    fn get_root_block_id(&self) -> String {
        super::types::ROOT_PARENT_ID.to_string()
    }
    ...
    async fn move_block_by_ref(
        ...
        use super::types::ROOT_PARENT_ID;
