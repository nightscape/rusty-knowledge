...
```rust
// crates/rusty-knowledge/src/storage/commands.rs (NEW FILE)
...
### 3. Command Executor
```rust
// crates/rusty-knowledge/src/storage/command_executor.rs (NEW FILE)
...
### 4. Sync Worker
```rust
// crates/rusty-knowledge/src/storage/sync_worker.rs (NEW FILE)
