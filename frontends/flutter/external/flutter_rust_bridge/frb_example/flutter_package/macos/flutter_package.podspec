...
# Run `pod lib lint flutter_package.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'flutter_package'
  s.version          = '0.0.1'
...
A new Flutter FFI plugin project.
  ...
  s.script_phase = {
    ...
    :script => 'sh "$PODS_TARGET_SRCROOT/../cargokit/build_pod.sh" ../rust flutter_package',
