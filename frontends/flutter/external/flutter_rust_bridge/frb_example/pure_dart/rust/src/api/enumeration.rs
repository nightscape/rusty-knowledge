...
pub type ChangeMapSinkTwinNormal =
    StreamSink<ChangeTwinNormal<std::collections::HashMap<String, String>>>;
...
#[frb(non_opaque)]
pub type BatchChangeMapTwinNormal =
    Batch<ChangeIgnoredTwinNormal<std::collections::HashMap<String, String>>>;

pub fn func_batch_change_map_twin_normal(
    arg: BatchChangeMapTwinNormal,
) -> BatchChangeMapTwinNormal {
    arg
}
...
#[frb(non_opaque)]
pub type ButchChangeMapTwinNormal =
    Butch<ChangeIgnoredTwinNormal<std::collections::HashMap<String, String>>>;

pub fn func_butch_change_map_twin_normal(
    arg: ButchChangeMapTwinNormal,
) -> ButchChangeMapTwinNormal {
    arg
}
