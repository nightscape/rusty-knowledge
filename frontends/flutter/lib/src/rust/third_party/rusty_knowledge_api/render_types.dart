...
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `RenderableItem`
// These function are ignored because they are on traits that is not defined in current crate (put an empty `#[frb]` on it to unignore): `assert_receiver_is_total_eq`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `eq`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`
...
class ParamMapping {
  ...
  static Future<ParamMapping> default_() =>
      RustLib.instance.api.rustyKnowledgeApiRenderTypesParamMappingDefault();
...
sealed class TypeHint with _$TypeHint {
  ...
  static Future<TypeHint> fromString({required String s}) =>
      RustLib.instance.api.rustyKnowledgeApiRenderTypesTypeHintFromString(s: s);

  /// Convert to legacy string format for backward compatibility
  Future<String> toStringLegacy() => RustLib.instance.api
      .rustyKnowledgeApiRenderTypesTypeHintToStringLegacy(that: this);
}
